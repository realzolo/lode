"""Reviewed provider model specifications used by account-model routing.
...
class ModelProfile:
    ...
    def profile_hash(self) -> str:
        payload = {
            ...
            "token_counting_strategy": self.token_counting_strategy,
...
_PROFILES = (
    ModelProfile(
        ...
        token_counting_strategy="local_tiktoken",
    ...
    ModelProfile(
        ...
        token_counting_strategy="anthropic_count_tokens",
...
def supported_models(provider_kind: str, protocol_id: str) -> tuple[ModelProfile, ...]:
    return tuple(
        profile
...
def find_model(provider_kind: str, protocol_id: str, model_id: str) -> ModelProfile | None:
...
def require_model(provider_kind: str, protocol_id: str, model_id: str) -> ModelProfile:
