...
Production hardening in this module:
  * CORS origins come from ``IT_CORS_ORIGINS`` (not hard-coded).
...
from incident_trace.api.routes.alerts import router as alerts_router
from incident_trace.api.routes.analyses import router as analyses_router
...
logger = logging.getLogger("incident_trace.api")
...
async def root() -> dict[str, str]:
    return {"service": "incident-trace", "status": "ok"}
